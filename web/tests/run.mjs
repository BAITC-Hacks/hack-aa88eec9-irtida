...
try {
  ...
  for (const name of ['api.ts', 'i18n.tsx', 'view-model.ts', 'import-state.ts', 'components/Icons.tsx', 'components/ProfileView.tsx', 'components/HrView.tsx', 'components/ImportPanel.tsx', 'components/AuthView.tsx', 'components/AccountView.tsx', 'components/CatalogView.tsx', 'components/AccountsView.tsx']) {
  ...
  const result = spawnSync(process.execPath, ['--test', 'tests/core.test.mjs', 'tests/views.test.mjs', 'tests/auth.test.mjs'], { stdio: 'inherit', env: { ...process.env, CQ_TEST_BUILD: target } });
