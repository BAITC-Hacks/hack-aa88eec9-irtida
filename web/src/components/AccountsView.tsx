...
import { api, type Account, type Employee, type Invitation, type RegisteredAccount } from '../api';
import { useI18n } from '../i18n';
import { Icon } from './Icons';

export function AccountsView({ accounts, people, busy, run, refresh }: {
    ...
    async function create(event: FormEvent<HTMLFormElement>) {
        ...
        await run('invite', async () => {
            const result = await api<Invitation>('/hr/invitations', { method: 'POST', body: JSON.stringify({ role, employee_id: role === 'employee' ? employeeId : null }) });
